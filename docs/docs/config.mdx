...
| app:workspacerail                                                    | bool     | Set to true to replace the workspace switcher button with a persistent workspace rail down the left edge of the window (defaults to false). Toggle compact/expanded from the chevron at the bottom of the rail                                              |
